...
namespace SdkExample8WebServiceUpload
{
    /// <summary>
    ...
    /// </summary>
    internal class SdkExample8WebServiceUpload
    {
        ...
        private static HttpRequestMessage CreateHttpRequestMessage()
        {
            ...
            {
                RequestUri = new Uri("http://localhost:80/HDSWEBAPI/api/HDCS/0/ed40775b-5e7d-4a51-b4d1-32bf9d6e9e29"),
