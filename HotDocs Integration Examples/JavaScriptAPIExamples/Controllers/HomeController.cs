...
using JavaScriptAPIExamples.Models;
using Util = HotDocs.Sdk.Util;

namespace JavaScriptAPIExamples.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            string postInterviewUrl = "PostInterviewProcessing";
            ...
            string interviewFileUrl = "GetInterviewFile";
